...
var accountCtrlStub = {
  ...
  upsert: 'accountCtrl.upsert',
  patch: 'accountCtrl.patch',
...
describe('Account API Router:', function() {
  ...
  describe('PUT /api/accounts/:id', function() {
    it('should route to account.controller.upsert', function() {
      expect(routerStub.put
        .withArgs('/:id', 'accountCtrl.upsert')
        ).to.have.been.calledOnce;
    });
  });

  describe('PATCH /api/accounts/:id', function() {
    it('should route to account.controller.patch', function() {
      expect(routerStub.patch
        .withArgs('/:id', 'accountCtrl.patch')
        ).to.have.been.calledOnce;
    });
  });
